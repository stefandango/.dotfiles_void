...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/fidget.nvim",
  ...
  ["lsp_lines.nvim"] = {
    ...
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/neoscroll.nvim",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/vim-sleuth",
